...
func PatchErr(err_msg string, c *gin.Context) {
  c.AbortWithStatusJSON(400, gin.H{"code":400, "msg":err_msg, "debug":c.Request.Body, "data":nil})
  }

func Fuduji(c *gin.Context) {
  fmt.Println(c.Request.Host, c.Request.RemoteAddr, c.Request.RequestURI)
  requestDump, err := httputil.DumpRequest(c.Request, true)
  if err != nil { LogOn(err, "Fuduji failed to init.") }
